...
class SecondLevelSeeder extends Seeder {
  async run(em: EntityManager, context: Dictionary) {
    ...
    context.systemDictTypeMenu = em.create(SysMenuEntity, { menuName: '字典管理', menuKey: 'sys.menu.system.dictType', menuType: MenuTypeEnum.MENU, orderNum: 4, path: 'dict/type', component: 'system/dict/type', isAvailable: YesOrNoEnum.YES, isCache: YesOrNoEnum.NO, isFrame: YesOrNoEnum.NO, isVisible: YesOrNoEnum.YES, parentId: systemMenu.id })
    ...
    context.monitorLoginLogMenu = em.create(SysMenuEntity, { menuName: '登录日志', menuKey: 'sys.menu.monitor.loginLog', menuType: MenuTypeEnum.MENU, orderNum: 2, path: 'login-log', component: 'monitor/login-log', isAvailable: YesOrNoEnum.YES, isCache: YesOrNoEnum.NO, isFrame: YesOrNoEnum.NO, isVisible: YesOrNoEnum.YES, parentId: monitorMenu.id })
...
class ThirdLevelSeeder extends Seeder {
  async run(em: EntityManager, context: Dictionary) {
    ...
    context.menus.push(
      ...
      em.create(SysMenuEntity, { menuName: '用户导出', menuKey: 'sys.menu.system.user.export', menuType: MenuTypeEnum.BUTTON, orderNum: 5, isAvailable: YesOrNoEnum.YES, parentId: systemUserMenu.id }),
      ...
      em.create(SysMenuEntity, { menuName: '岗位导出', menuKey: 'sys.menu.system.post.export', menuType: MenuTypeEnum.BUTTON, orderNum: 5, isAvailable: YesOrNoEnum.YES, parentId: systemPostMenu.id }),
      ...
      em.create(SysMenuEntity, { menuName: '角色导出', menuKey: 'sys.menu.system.role.export', menuType: MenuTypeEnum.BUTTON, orderNum: 5, isAvailable: YesOrNoEnum.YES, parentId: systemRoleMenu.id }),
      ...
      em.create(SysMenuEntity, { menuName: '字典导出', menuKey: 'sys.menu.system.dictType.export', menuType: MenuTypeEnum.BUTTON, orderNum: 5, isAvailable: YesOrNoEnum.YES, parentId: systemDictTypeMenu.id }),
      ...
      em.create(SysMenuEntity, { menuName: '字典数据导出', menuKey: 'sys.menu.system.dictData.export', menuType: MenuTypeEnum.BUTTON, orderNum: 5, isAvailable: YesOrNoEnum.YES, parentId: systemDictDataMenu.id }),
