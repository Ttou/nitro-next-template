...
import { SysDictDataEntity, SysUserEntity } from '~shared/entities'
...
export class SystemUserService {
  ...
  async create(dto: CreateSystemUserReqDto) {
    ...
    const password = await this.hashService.bcryptCrypto(dto.password)
  ...
  async importTemplate(data: ImportSystemUserSerializeDto[]) {
    ...
    const password = await this.hashService.bcryptCrypto(initPassword)
